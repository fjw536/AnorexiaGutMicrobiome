...
# Figure 2A - contrasted gbms between AN and NC
...
# Figure 2B - heatmap visualizing the linear regression model between gbms and bioclinical variables
...
# Figure 3A - bar plot of amount of identified vsdv and dsgv in the combined cohort
...
# Figure 3B - pie plot of compistion of SVs in the combined cohort
...
# Figure 3C - beta diversity of SVs in the combined cohort
## Get distance matrix
## All samples
sgv<-cbind(vsgv, dsgv)
...
# Figure 3D - chord diagram of the association between eating disorder scores and bacterial SVs
## Load data
vsgv <- read.csv("vsgv.csv", header = T, check.names = F, row.names = 1)
...
# Figure 3E - heatmap showing the association between Bacteroides uniformis SVs and eating disorder scores
...
# Figure 3G - Boxplot for individuals with and without the deletion region
...
# Figure 4A - PCA plot of metabolome between AN and NC
MSP[is.na(MSP)] <- 0
...
# Figure 4B - contrasted metabolites between AN and NC after drug deconfounding
...
# Figure 4D - sankey plot visualizing the mediation outcomes where microbial features were treatments, metabolites were mediators, and eating disorder scores were outcomes
...
# Figure 5A and 5B - Richness and Shannon diversity of viral gut microbiota between AN and NC
...
# Figure 5C - contrasted viral gut microbiota between AN and NC
...
# Figure 5D - Numbers of SparCC in AN and NC
...
## Assembly all elements of Figure 5 and export
...
# Figure 6G - heatmap showing the correlation between transferred ASVs and gene expression in adipose tissue and hypothalamus of GF recipients
...
# Extended Data Figure 7A - example code for plotting SV distributions in bacteriome
...
# Extended Data Figures 7B, 7C. 7D - A. putredinis and glucose metabolism
cov.1 <- c('Age', 'Smoking', 'SSRI', 'Antipsychotics', 'Benzodiazepines')
...
# Extended Data Figure 9 - PCoA plot of the Canberra distance showing the stratification of AN-RS from the AN-BP at species level.
...
# Supplementary Figure 3 - heatmap showing the viral-bacterial transkingdom interactions between two AN subtypes
